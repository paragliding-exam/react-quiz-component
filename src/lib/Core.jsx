...
const Core = function ({
  ...
  }, [endQuiz]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  const nextQuestion = (currentQuestionIdx) => {
    ...
    if (currentQuestionIdx + 1 === questions.length) {
      if (userInput.length !== questions.length) {
        ...
        const submitQuiz = window.confirm(
  ...
  }, [endQuiz, filteredValue]); // eslint-disable-line react-hooks/exhaustive-deps
